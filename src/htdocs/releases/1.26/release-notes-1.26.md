...
The latest bug-fix release in the stable 1.26 series is [1.26.11](#1.26.11) and was released on 10 March 2026

See [https://gstreamer.freedesktop.org/releases/1.26/][latest] for the latest version of this document.

The GStreamer 1.26 stable series has now been superseded by the [GStreamer 1.28 stable release series][gstreamer-1.28].

*Last updated: Sunday 08 March 2026, 12:00 UTC [(log)][gitlog]*
...
[gstreamer-1.28]: https://gstreamer.freedesktop.org/releases/1.28/
...
**Possibly breaking behavioural changes**
 ...
 - Previously it was guaranteed that there is only ever up to one `GstTensorMeta` per buffer.
   ...
   `GstTensorMeta` now (after this [Merge Request](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9601)).

#### gstreamer

 - [baseparse: Try harder to fixate caps based on upstream in default negotiation](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9603)
 - [gst-discoverer reports 1x1 dimensions for "valid" MP4 files](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/issues/4608)
 - [baseparse: don't clear most sticky events after a FLUSH_STOP event](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9594)
 - [gstreamer: Disable miniobject inline functions for gobject-introspection for non-subprojects too](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9519)
 - [gstreamer: Make sure to zero-initialize the GValue before G_VALUE_COLLECT_INIT](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9529)
 - [ptp: Fix a new Rust 1.89 compiler warning on Windows](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9528)
 - [ptp: Fix new compiler warning with Rust 1.89](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9516)
 - [Segmentation fault when compiled with "-ftrivial-auto-var-init=pattern". Use of unitialized GValue.](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/issues/4595)

#### gst-plugins-base

 - [decodebin3: Update stream tags](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9566)
 - [rtpbasedepayload: Avoid potential use-after free](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9581)
 - [rtspconnection: Add get_url and get_ip return value annotation](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9656)
 - [gst_rtsp_connection_get_url return value transfer annotation missing](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/issues/3726)
 - [videometa: Fix valgrind warning when deserializing video meta](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9654)
 - [videorate: don't hold the reference to the buffer in drop-only mode](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9548)
 - [gst-device-monitor-1.0: Fix device-path regression on Windows](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/issues/4620)
 - [gst-device-monitor-1.0: Add quoting for powershell and cmd](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9634)
 - [Monorepo: opengl, vorbis, plugins require explicit enablement now for a build using the Meson subproject fallback](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9637)

#### gst-plugins-good

 - [adaptivedemux2: fix crash due to log](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9574)
 - [adaptivedemux2: Crash in logging when "Dropping EOS before next period"](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/issues/4588)
 - [hlsdemux2: Fix parsing of byterange and init map directives](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9541)
 - [mpg123audiodec: Always break the decoding loop and relay downstream flow errors upstream](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9685)
 - [v4l2: Add support for WVC1 and WMV3](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9669)
 - [Monorepo: dv plugin requires explicit enablement now for a build using the Meson subproject fallback](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9637)

#### gst-plugins-bad

 - [analytics: always add GstTensorMeta](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9601)
 - [cccombiner: Crash fixes](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9559)
 - [curlsmtpsink: adapt to date formatting issue](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9645)
 - [decklinkvideosrc: fix decklinkvideosrc becomes unrecoverable if it fails to start streaming](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9592)
 - [decklinkvideosrc gets into unrecoverable state if device is busy](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/issues/2611)
 - [dwrite: Fix D3D12 critical warning](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9686)
 - [hlsdemux: Fix parsing of byterange and init map directives](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9541)
 - [mpegtsmux: Caps event fails with stream type change error](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9678)
 - [vulkanh24xdec: couple of fixes](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9562)
 - [vulkanh26xdec: fix discont state handling](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9613)
 - [waylandsink: add some error handler for event dispatch](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9537)
 - [zbar: tests: Handle symbol-bytes as not null-terminated](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9514)
 - [Monorepo: avtp, codec2json, iqa, microdns, openjpeg, qroverlay, soundtouch, tinyalsa plugins require explicit enablement now for a build using the Meson subproject fallback](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9637)
...
#### GStreamer Rust plugins
 ...
 - [analyticscombiner: Use NULL caps instead of EMPTY caps in the array for streams with no caps](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2513)
 - [aws: Ensure task stopping on paused-to-ready state change](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2453)
 - [fallbacksrc: Don't panic during retries if the element was shut down in parallel](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2452)
 - [fallbacksrc: Don't restart source if the element is just being shut down](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2457)
 - [fallbacksrc: Fix some custom source deadlocks](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2475)
 - [fallbacksrc: Fix sources only being restarted once](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2550)
 - [gtk4: Try importing dmabufs withouth DMA_DRM caps](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2492)
 - [inter: Give the appsrc/appsink a name that has the parent element as prefix](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2546)
 - [mp4: Skip tests using x264enc if it does not exist](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2505)
 - [rtpgccbwe: avoid clamp() panic when min_bitrate > max_bitrate](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2458)
 - [rtpmp4gdepay2: allow only constantduration with neither constantsize nor sizelength set](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2488)
 - [rtprecv: fix race condition on first buffer](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2469)
 - [speechmatics: Specify rustls as an explicit dependency](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2504)
 - [spotify: update to librespot 0.7](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2538)
 - [threadshare: add a blocking adapter element](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2467)
 - [threadshare: always use `block_on_or_add_subtask`](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2495)
 - [threadshare: audiotestsrc: fix setting samples-per-buffer...](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2462)
 - [threadshare: blocking_adapter: fix Since marker in docs](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2482)
 - [threadshare: fix resources not available when preparing asynchronously](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2522)
 - [threadshare: fix ts-inter test one_to_one_up_first](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2498)
 - [threadshare: have Task log its obj](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2478)
 - [threadshare: intersink: return from blocking tasks when stopping](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2468)
 - [threadshare: inter: update doc example](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2480)
 - [threadshare: runtime/pad: lower log level pushing Buffer to flushing pad](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2514)
 - [threadshare: separate blocking & throttling schedulers](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2530)
 - [threadshare: update examples](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2485)
 - [threadshare: Update to getifaddrs 0.5](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2507)
 - [threadshare: Fix macOS build post getifaddrs 0.5 update](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2523)
 - [threadshare: Bump up getiffaddrs to 0.1.5 and revert "udp: avoid getifaddrs in android"](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2542)
 - [threadshare: Reapply "udp: avoid getifaddrs in android"](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2543)
 - [transcriberbin: Fix some deadlocks](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2464)
 - [Update dependencies](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2449)
 - [webrtc: Migrate to warp 0.4 and switch to tokio-rustls](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2501)
 - [webrtc/signalling: Fix setting of host address](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2541)
 - [ci: add script to check readme against plugins list](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2447)
 - [Fix various new clippy 1.89 warnings](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2437)
 - [Don't suggest running `cargo cinstall` after `cargo cbuild`](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2445)
 - [meson: Isolate built plugins from cargo target directory](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2535)
...
#### gst-rtsp-server
 ...
 - [rtsp-server: tests: Switch to fixtures to ensure pool shutdown](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9635)
...
#### gst-python
 ...
 - [python: Handle buffer PTS/DTS/duration/offset/offset-end as unsigned long long](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9569)

#### gst-editing-services

 - [gstreamer: Make sure to zero-initialize the GValue before G_VALUE_COLLECT_INIT](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9529)
 - [Fix various memory leaks](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9643)

#### gst-devtools, gst-validate + gst-integration-testsuites

 - [validate: http-actions: Replace GUri with GstURI for GLib 2.64 compatibility](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9576)
 - [Fix memory leak and use of incorrect context](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9636)
...
#### Development build environment
 ...
 - [gobject-introspection: Fix introspection failing on Linux with subproject GLib](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9515)
 - [glib: update to 2.82.5 and backport shebangs patch](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9587)
 - [ci: Work around PowerShell broken argument parsing](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9420)
 - [Disable more plugins on Windows by default by not pulling in fallback subprojects automatically, only if plugins are enabled explicitly](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9637)
 - [Fix build on windows due to proxy-libintl not being invoked](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9637)
 - [python: Reapply fixes to enable running Python bindings on Windows](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9644)

#### Cerbero build tool and packaging changes in 1.26.6

 - [ffmpeg: enable filters needed by avvideocompare](https://gitlab.freedesktop.org/gstreamer/cerbero/-/merge_requests/1928)
 - [cache: Fix detection of build tools prefix when using a cache](https://gitlab.freedesktop.org/gstreamer/cerbero/-/merge_requests/1930)
 - [cerbero/package: fix --tarball --compress-method=none](https://gitlab.freedesktop.org/gstreamer/cerbero/-/merge_requests/1934)
 - [cerbero: Reduce recipe parallelism in various cases](https://gitlab.freedesktop.org/gstreamer/cerbero/-/merge_requests/1939)
 - [ci: remove unpacked apk dir on completion](https://gitlab.freedesktop.org/gstreamer/cerbero/-/merge_requests/1940)
 - [package: Dump cerbero and recipe versions into datadir](https://gitlab.freedesktop.org/gstreamer/cerbero/-/merge_requests/1924)

#### Contributors to 1.26.6

Andrey Khamukhin, Daniel Morin, Doug Nazar, François Laignel,
Guillaume Desmottes, Hou Qi, Ian Napier, Jan Alexander Steffens (heftig),
Jan Schmidt, Jordan Petridis, L. E. Segovia, Marko Kohtala, Matthew Waters,
Monty C, Nirbheek Chauhan, Ola Fornander, Olivier Crête, Piotr Brzeziński,
Qian Hu (胡骞), r4v3n6101, Robert Mader, Ruben Gonzalez, Sanchayan Maity,
Sebastian Dröge, Seungha Yang, Taruntej Kanakamalla, Thibault Saunier,
Tim-Philipp Müller, Víctor Manuel Jáquez Leal, Vivian LEE, Vivienne Watermeier,
Xavier Claessens, 
...
- [List of Merge Requests applied in 1.26.6](https://gitlab.freedesktop.org/groups/gstreamer/-/merge_requests?scope=all&utf8=%E2%9C%93&state=merged&milestone_title=1.26.6)
- [List of Issues fixed in 1.26.6](https://gitlab.freedesktop.org/groups/gstreamer/-/issues?scope=all&utf8=%E2%9C%93&state=closed&milestone_title=1.26.6)
...
#### gstreamer
 ...
 - [controller: Fix get_all() return type annotation](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9831)
 - [gst-launch: Do not assume error messages have a src element](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9739)
 - [multiqueue: Fix object reference handling in signal callbacks](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9742)
 - [netclientclock: Fix memory leak in error paths](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9741)

#### gst-plugins-base

 - [discoverer: Mark gst_discoverer_stream_info_list_free() as `transfer full`](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9822)
 - [qt: Fix building examples on macOS](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9768)
 - [riff: Add channel reorder maps for 3 and 7 channel audio](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9744)
 - [sdp: proper usage of gst_buffer_append](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9720)
 - [videorate: fix assert fail due to invalid buffer duration](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9829)
 - [Fix build error with glib < 2.68](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9708)

#### gst-plugins-good

 - [matroskamux: Properly check if pads are EOS in find_best_pad](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9821)
 - [qt: Fix building examples on macOS](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9768)
 - [qtdemux: bad performance with GoPro videos containing FDSC metadata tracks](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/issues/4679)
 - [qtdemux: fix open/seek perf for GoPro files with SOS track](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9832)
 - [qtdemux: handle unsupported channel layout tags gracefully](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9752)
 - [qtdemux: set channel-mask to 0 for unknown layout tags](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9754)
 - [rtspsrc: Send RTSP keepalives in TCP/interleaved modes](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9801)
 - [v4l2: Add GstV4l2Error handling in gst_v4l2_get_capabilities](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9714)
 - [v4l2: Fix memory leak for DRM caps negotiation](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9781)
 - [v4l2transform: reconfigure v4l2object only if respective caps changed](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9699)
 - [Fix issues with G_DISABLE_CHECKS & G_DISABLE_ASSERT](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9721)

#### gst-plugins-bad

 - [cuda: Fix runtime kernel compile with CUDA 13.0](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9769)
 - [d3d12convert: Fix crop meta support](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9743)
 - [d3d12deinterlace: Fix passthrough handling](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9696)
 - [gst: Fix a few small leaks](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9761)
 - [matroskamux: Properly check if pads are EOS in find_best_pad](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9821)
 - [tsdemux: Directly forward Opus AUs without `opus_control_header`](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9765)
 - [tsmux: Write a full Opus channel configuration if no matching Vorbis one is found](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9733)
 - [unixfd: Fix case of buffer with big payload](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9706)
 - [vacompositor: Correct scale-method properties](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9726)
 - [webrtc: nice: Fix a use-after-free and a mem leak](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9816)
 - [Fix all compiler warnings on Fedora](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9715)
 - [Fix issues with G_DISABLE_CHECKS & G_DISABLE_ASSERT](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9721)
...
#### GStreamer Rust plugins
 ...
 - [cea608overlay: Support non-system memory correctly](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2560)
 - [fallbacksrc: Fix custom source reuse case](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2595)
 - [fallbacksrc: Fix sources only being restarted once](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2550)
 - [fallbacksrc: Post no-more-pads signal for streams-unaware parent](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2558)
 - [inter: add properties to fine tune the inner elements](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2569)
 - [onvifmetadatapay: copy metadata from source buffer](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2600)
 - [rtp: Add linear audio (L8, L16, L24) RTP payloaders / depayloaders](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2623)
 - [rtpamrpay2: Actually forward the frame quality indicator](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2581)
 - [rtpamrpay2: Set frame quality indicator flag](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2578)
 - [rtp: basedepay: reuse last PTS, when possible to work around problems with NVIDIA Jetson AV1 encoder](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2612)
 - [rtpsend/recv: fix property type for stats](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2559)
 - [threadshare: audiotestsrc: support more Audio formats](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2607)
 - [threadshare: backpressure: abort pending items on flush start](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2606)
 - [threadshare: fixes & improvements](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2624)
 - [threadshare: latency related improvements and fixes](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2588)
 - [threadshare: runtime task: execute action in downward transition](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2604)
 - [threadshare: udpsink: fix panic recalculating latency from certain executors](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2610)
 - [uriplaylistbin: Ignore all tests for now](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2570)
 - [webrtc: livekit: Drop connection lock after take()](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2616)
 - [Update dependencies](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2572)
 - [Update dependencies](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2620)
 - [ci: use image and GST_RS_MSRV / GST_RS_STABLE variables from gstreamer-rs 0.24 in gst-plugins-rs 0.14 branch](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2563)
 - [Add `rust-tls-native-roots` feature to the `reqwest` dep](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2589)
 - [Fix some new clippy 1.90 warnings](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2576)
 - [meson: Fix .pc files installation and simplify build output handling](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2566)
...
#### gst-editing-services
 ...
 - [ges: timeline: Respect SELECT_ELEMENT_TRACK signal discard decision](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9811)
 - [gst: Fix a few small leaks](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9761)
...
#### Development build environment
 ...
 - [libsoup.wrap: Apply upstream fix for GModule deadlock](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/9697)

#### Cerbero build tool and packaging changes in 1.26.7

 - [meson: Update to 1.9.0 to enable Xcode 26 compatibility](https://gitlab.freedesktop.org/gstreamer/cerbero/-/merge_requests/1951)
 - [osxrelocator: Add .so to the allowed dylib extensions](https://gitlab.freedesktop.org/gstreamer/cerbero/-/merge_requests/1953)
 - [ci: update macos image to 26-tahoe](https://gitlab.freedesktop.org/gstreamer/cerbero/-/merge_requests/1954)
 - [EndeavourOS support](https://gitlab.freedesktop.org/gstreamer/cerbero/-/merge_requests/1956)

#### Contributors to 1.26.7

Andoni Morales Alastruey, Branko Subasic, Vincent Beng Keat Cheah, Doug Nazar,
Ekwang Lee, François Laignel, Inbok Kim, Jakub Adam, Jan Schmidt,
Jochen Henneberg, L. E. Segovia, Mark Nauwelaerts, Markus Hofstaetter,
Matthew Waters, Nirbheek Chauhan, Norbert Hańderek, Philippe Normand,
Razvan Grigore, Sebastian Dröge, Seungha Yang, Taruntej Kanakamalla,
Thibault Saunier, Tim-Philipp Müller, Xavier Claessens,
...
#### gstreamer
 ...
 - [info: Force comparison to same types](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10168)
 - [queue: Use GST_PTR_FORMAT everywhere](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10189)
 - [streamcollection: Fix race condition between disconnecting notify proxy and notifications](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10207)
 - [value: Fix GstAllocationParams string serialisation on 32-bit architectures](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10250)

#### gst-plugins-base

 - [allocators: drmdumb: Keep dmabuf mapped](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10164)
 - [alsadeviceprovider: Fix device name leak](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10228)
 - [audiovisualizer: Use break instead of goto for escape logic](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10184)
 - [decodebin3: Clear previous collection on input](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10156)
 - [decodebin3: Consider certain meta caps in decodebin3 as raw format to avoid warnings](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10251)
 - [decodebin3: Protect again NULL dereference if input slot can't be mapped](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10253)
 - [glbasesrc: Add unlock handling for non-negotiated cases](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10140)
 - [glcolorconvert: Fix memory leak in _create_shader](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10065)
 - [gldownload: Keep dmabuf mapped](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10164)
 - [glfiltershader: Add missing unlock](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10133)
 - [glstereosplit: Add missing unlock for exceptional case](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10148)
 - [pbutils: Fix bit shifting when generate hevc mime codec string](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10183)
 - [rtpbaseaudiopay: Consider RESYNC flag as discontinuity too](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10066)
 - [rtpbasedepayload: Add missing unlock in error code path](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10157)
 - [uridecodebin3: Add null check of play items in purge](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10134)
 - [urisourcebin: Add missing unlock](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10158)
 - [urisourcebin: Fix initial values of min_byte_level and min_time_level variables](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10132)
 - [videoencoder: fix warning of uninitialized buffer](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10215)

Tools:

 - [gst-play-1.0: fix printing of missing plugin details](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10176)
 - [gst-play-1.0: Add missing unlock for invalid track type](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10147)

#### gst-plugins-good

 - [adaptivedemux2: Fix a crash on rapid state changes, and startup busy waiting](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10247)
 - [hlsdemux2: Keep streams with different names](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10248)
 - [hlsdemux2: error out instead of asserting on negative stream time](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10094)
 - [hlsdemux2: Not all subtitles are present in track/collection. Usage of `FORCE` `EXT-X-MEDIA` field](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/issues/2636)
 - [osxaudio: Remove unnecessary if, add comment about GstDevice lifetime](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10235)
 - [osxaudio: Various fixes, incl a potential crash when probing](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10141)
 - [v4l2allocator: Add KEEP_MAPPED flag to the allocated buffers](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10164)
 - [v4l2videoenc: Fix codec frame leak on error](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10149)

#### gst-plugins-bad

 - [Add missing G_DECLS symbols to gstvkqueue and gstvkcommandqueue](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10085)
 - [ajasink, decklinkvideosrc: Fix some GstAncillaryMeta handling bugs](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10171)
 - [analyticsmeta: Initialize span to avoid undefined behavior](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10060)
 - [GstPlay: Fixed wrong initial position update interval configuration](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10122)
 - [id3tag: Fix resource leak](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10067)
 - [mpegtsmux: Avoid infinite recursion writing PCR packets](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10150)
 - [mxfdemux: Fix typo on mxf_ffv1_create_caps](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10116)
 - [mxfmux: Fix memset usage](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10255)
 - [mpegtsmux: segfaults when bitrate is configured lower than bitrate that's coming in](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/issues/4752)
 - [osxaudio: Various fixes, incl a potential crash when probing](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10141)
 - [scte-section: fix missing cleanup on splice component parse failure](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10093)
 - [tsdemux: expose audio GstStream for DTS](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10251)
 - [va, unixfdsrc: keep dmabufs mapped](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10164)
 - [vkh265dec: Fix a typo](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10170)
 - [vkvideo-private: Replace GstBuffer with GstMemory array for video sessions](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10185)
 - [vtdec: Fix race condition in decoder draining. Fluster runs were unstable](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10231)

#### gst-plugins-ugly

 - [rmdemux: Remove unnecessary condition](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10159)

#### GStreamer Rust plugins

 - [analytics splitter/combiner: Remove the separate fields to events and buffer](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2703)
 - [audiornnoise: copy input metadatas to ouput buffer](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2694)
 - [closedcaption: cctost2038anc: Support alignment](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2705)
 - [closedcaption: st2038ancdemux: Support alignment](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2702)
 - [closedcaption: st2038ancmux: Support frame alignment](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2699)
 - [closedcaption: st2038: Forward frame rate in caps where available](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2685)
 - [closedcaption: Add ST-2038 combiner and extractor element](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2723)
 - [closedcaption: st2038extractor: Some fixes](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2727)
 - [closedcaption: st2038combiner: Some fixes](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2726)
 - [gif: Update to gif 0.14](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2690)
 - [gtk4: Add property to control reconfigure on window-resize behavior](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2718)
 - [gtk4: Fix compile warning](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2714)
 - [fmp4, mp4: Implement GstChildProxy for MP4Mux and FMP4Mux](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2696)
 - [fmp4: Update to dash-mpd 0.19](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2679)
 - [ndisrcdemux: fix audio corruption with non-interleaved stride padding](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2722)
 - [net/quinn: Update web-transport-quinn and fix flaky QUIC test](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2717)
 - [rtp: Add SMPTE ST291-1 (ANC) RTP payloader and depayloader](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2706)
 - [spotify: bump librespot 0.8.0](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2695)
 - [webrtcsink: Don't let recalculate_latency block tokio worker thread](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2719)
 - [webrtcsink: support va encoders](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2687)
 - [Update dependencies](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2716)
 - [meson: fix build when GTK is not present](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2715)
...
#### gst-python
 ...
 - [gst-python: fix cross-compiling](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10174)
 - [python: Add some typing annotation to overrides](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10241)
...
#### gst-devtools, gst-validate + gst-integration-testsuites
 ...
 - [debug-viewer: Make 0x prefix optional thread ID regexes](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10089)
...
#### Development build environment
 ...
 - [libsoup wrap: remove fallback gio-unix on windows build](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10191)
 - [webrtc-audio-processing wrap: Fix build with abseil-cpp 202508](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10186)

#### Cerbero build tool and packaging changes in 1.26.9

 - [Add support for Visual Studio 2026 (Insiders)](https://gitlab.freedesktop.org/gstreamer/cerbero/-/merge_requests/1985)
 - [Fix extraction on Windows when building on a different drive than C:\, bump pixman and pygobject](https://gitlab.freedesktop.org/gstreamer/cerbero/-/merge_requests/1984)
 - [cookbook: List all the dependencies when listed in reverse](https://gitlab.freedesktop.org/gstreamer/cerbero/-/merge_requests/1988)
 - [gst-plugins-bad: actually build svtjpegxs plugin on 64-bit Windows](https://gitlab.freedesktop.org/gstreamer/cerbero/-/merge_requests/1983)

#### Contributors to 1.26.9

Artem Martus, Chengfa Wang, Dominique Leroux, Dongjoo Kim, Doug Nazar,
Edward Hervey, Gang Zhao, Hyunjun Ko, Jaehoon Lee, Jakub Adam, Jan Schmidt,
Jeongmin Kwak, Jerome Colle, Jihoon Lee, Jordan Yelloz, L. E. Segovia,
Matthew Semeniuk, Max Goltzsche, Michael Olbrich, Monty C, Nicolas Dufresne,
Nirbheek Chauhan, Olivier Crête, Philippe Normand, Pratik Pachange,
Qian Hu (胡骞), Robert Mader, Ruben Gonzalez, Sanchayan Maity,
Santiago Carot-Nemesio, Sebastian Dröge, Seungha Yang, Stéphane Cerveau,
...
- [List of Merge Requests applied in 1.26.9](https://gitlab.freedesktop.org/groups/gstreamer/-/merge_requests?scope=all&utf8=%E2%9C%93&state=merged&milestone_title=1.26.9)
- [List of Issues fixed in 1.26.9](https://gitlab.freedesktop.org/groups/gstreamer/-/issues?scope=all&utf8=%E2%9C%93&state=closed&milestone_title=1.26.9)
...
#### gstreamer
 ...
 - [pipeline: Improve resource cleanup logic for clock objects](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10270)
 - [filesink: fix the build with recent mingw-w64](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10277)
 - [basetransform, basesrc: Fix handling of buffer pool configuration failures](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10304)

#### gst-plugins-base

 - [basetextoverlay: Don't negotiate if caps haven't changed](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10357)
 - [codec-utils: Update mime codec strings](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10327)
 - [fdmemory: Fix size calculation when sharing](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10309)
 - [gl elements add a yellow bar on JPEGs with non-even heights](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/issues/4783)
 - [glimagesink: Fix handling of odd height buffers](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10345)
 - [glwindow_cocoa: fix window not closing (w/o user window handle)](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10361)
 - [opusenc: Simplify Vorbis channel layout mapping code and fix 7.1 layout & use surround multistream encoder](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10376)
 - [parsebin: Improve debug logging](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10397)
 - [playbin3: ensure GST_EVENT_SELECT_STREAMS event is sent to collection source](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10394)
 - [tagdemux: propagate seek event seqnum to upstream](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10359)
 - [videodecoder: Don't assume the ALLOCATION query contains a pool](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10347)
 - [videodecoder, videoaggregator: Fix handling of buffer pool configuration failures](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10304)

#### gst-plugins-good

 - [adaptivedemux2: Initialize start bitrate for dashdemux2 and hlsdemux2](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10289)
 - [dashdemux2: Unknown codec 'flac' when streaming a DASH MPD manifest with a mp4 FLAC file](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/issues/4789)
 - [deinterlace: Improve pool configuration](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10328)
 - [flac: Fix 6.1 / 7.1 channel layouts](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10378)
 - [flacdec: Don't forbid S32 sample size (0x07) unnecessarily](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10372)
 - [flacenc: Support S32 samples](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10379)
 - [flacdec: Decode 32-bit FLAC files](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/issues/4808)
 - [level: fix crash if no caps have been sent](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10441)
 - [level: Floating point exception (core dumped) when sending buffers without caps](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/issues/4769)
 - [matroskademux: Bump maximum block size from 15MB to 32MB to allow 4k raw video](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10419)
 - [matroskamux: Fix some more thread-safety issues](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10355)
 - [matroskamux: Fix thread-safety issues when requesting new pads](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10346)
 - [matroskamux: pad->track handling results in segmentation fault](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/issues/4800)
 - [mxfdemux / aiffparse / matroskaparse: Remove segment closing on non-flushing seeks](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10400)
 - [qtdemux: Use gst_util_uint64_scale to scale guint64](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10293)
 - [qtmux: Fix robust recording estimates](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10290)
 - [splitmuxsrc - fix for seeking / flushing deadlock](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10348)
 - [v4l2object: Add support for colorimetry 1:4:16:3](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10326)
 - [wavenc: Fix downstream negotiation](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10413)
 - [wavparse: prevent setting empty strings as title tag](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10273)

#### gst-plugins-bad

 - [aesenc / aesdec: use correct format specifier for buffer size in debug log](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10398)
 - [analytics: Fix build on MSVC by using libm dependency](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10288)
 - [curlhttpsrc: Various fixes](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10274)
 - [decklinkvideosink: Fix frame completion callbacks for firmware 14.3+](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10322)
 - [dtlsdec: mark generated cert agent with GST_OBJECT_FLAG_MAY_BE_LEAKED](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10371)
 - [fdkaacdec: Assertion on handling unsupported channel layouts](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/issues/4791)
 - [fdkaacdec: Invalidate channel_types/indices when setting a known config](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10373)
 - [hlssink: Guard NULL structure and use gst_structure_has_name()](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10395)
 - [midiparse: Fix a couple of potential out-of-bounds reads](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10280)
 - [mpegtsmux: Fix potential deadlock changing pmt-interval](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10272)
 - [mxfdemux: reconsider "closing running segment" for non flushing seeks](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/issues/4803)
 - [mxfdemux / aiffparse / matroskaparse: Remove segment closing on non-flushing seeks](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10400)
 - [mxfdemux: Simplify timestamp tracking](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10406)
 - [mxfdemux: send event SegmentDone for segment seeks](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10391)
 - [mxfmpeg: Add custom Sony picture essence coding UL](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10271)
 - [playbin3: ensure GST_EVENT_SELECT_STREAMS event is sent to collection source](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10394)
 - [vabasedec: Don't assert when negotiating based on a gap event before the first buffer](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10302)
 - [vkformat: Add VK_FORMAT_G10X6_B10X6R10X6_2PLANE_420_UNORM_3PACK16 format](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10360)
 - [webrtc: Keep a ref of the ICEStream in the TransportStream](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10318)
 - [GstPlay: set_audio_track_enabled / set_video_track_enabled not functioning for adaptivedemux2 sources](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/issues/4747)
 - [video: decoders: Fix possible crash when flushing H265/H266 decoder](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10431)
...
#### GStreamer Rust plugins
 ...
 - [cctost2038anc: Fix typo with c_not_y_channel property documentation](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2735)
 - [dav1d: Stop iteration after finding first working pool](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2749)
 - [dav1d: Various fixes to allocation query handling](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2747)
 - [gtk4paintablesink: Propose a udmabuf pool / allocator if upstream asks for sysmem](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2767)
 - [gtk4: Fix typo in odd-size subsample workaround](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2758)
 - [rtp: Update to rtcp-types 0.3](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2761)
 - [st2038combiner: Some fixes](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2726)
 - [st2038extractor: Add always-add-st2038-pad property](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2734)
 - [threadshare: allow disabling the IPv4 or IPv6 socket in ts-udpsink](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2771)
 - [threadshare: Update to flume 0.12](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2748)
 - [tracers: add function and signal for writing logs to PadPushTimings](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2751)
 - [version-helper: Update to toml_edit 0.24](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2766)
 - [webrtc: mark static caps with GST_MINI_OBJECT_FLAG_MAY_BE_LEAKED](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2775)
 - [webrtcsink: don't upscale when mitigating low bitrate](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2737)
 - [Fix new clippy 1.92 warnings](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2755)
 - [Update dependencies](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2772)

#### gst-libav

 - [avviddec: Various fixes to allocation query handling](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10347)
 - [avviddec: Aggregate GstVideoAlignment on top of the meta api params, instead of overriding them](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/issues/4788)
 - [avviddec: Set video alignment to internal pool](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10440)
...
#### gst-python
 ...
 - [Override GstPadProbeInfo to get writable objects](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10291)
 - [Misc improvements](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10310)
 - [More typing fixes](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10303)
 - [1.26.2 breaks Python bindings: No longer able to modify Gst.Buffer metadata in pad probe callbacks](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/issues/4714)

#### gst-editing-services

 - [python: More typing fixes](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10303)

#### gst-devtools,gst-validate + gst-integration-testsuites

 - [dotsviewer: Update Rust dependencies](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10392)

#### gst-examples

 - [webrtc: Update Rust dependencies](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10392)
...
#### Cerbero build tool and packaging changes in 1.26.10
 ...
 - [pkg-config: Ship it in the devel package](https://gitlab.freedesktop.org/gstreamer/cerbero/-/merge_requests/2026)
 - [recipe: Update License enums to SPDX expressions](https://gitlab.freedesktop.org/gstreamer/cerbero/-/merge_requests/2020)
 - [recipes: Fix GPL categorization of some plugins](https://gitlab.freedesktop.org/gstreamer/cerbero/-/merge_requests/2015)
 - [recipes: Fix stray devel files making it into runtime](https://gitlab.freedesktop.org/gstreamer/cerbero/-/merge_requests/2005)
 - [recipes: add GstApp python binding](https://gitlab.freedesktop.org/gstreamer/cerbero/-/merge_requests/2013)
 - [Modernize MSI license.rtf formatting](https://gitlab.freedesktop.org/gstreamer/cerbero/-/merge_requests/1998)
 - [Use ninja for all cmake recipes by default instead of GNU make](https://gitlab.freedesktop.org/gstreamer/cerbero/-/merge_requests/2017)
 - [ci: Mark a racy xcode toolchain bug for retrying](https://gitlab.freedesktop.org/gstreamer/cerbero/-/merge_requests/2016)

#### Contributors to 1.26.10

Aaron Boxer, Brad Reitmeyer, Christoph Reiter, Doug Nazar, F. Duncanh,
François Laignel, Haejung Hwang, Hou Qi, Hyunjun Ko, Jakub Adam, Jan Schmidt,
Jeongmin Kwak, Jerome Colle, L. E. Segovia, Mathieu Duponchelle,
Nicolas Dufresne, Nirbheek Chauhan, Philippe Normand, Piotr Brzeziński,
Pratik Pachange, Robert Mader, Sanchayan Maity, Sebastian Dröge,
Stéphane Cerveau, Thibault Saunier, Tim-Philipp Müller, Tobias Schlager,
Vivia Nikolaidou, Wilhelm Bartel, Xavier Claessens, Yun Liu,
...
- [List of Merge Requests applied in 1.26.10](https://gitlab.freedesktop.org/groups/gstreamer/-/merge_requests?scope=all&utf8=%E2%9C%93&state=merged&milestone_title=1.26.10)
- [List of Issues fixed in 1.26.10](https://gitlab.freedesktop.org/groups/gstreamer/-/issues?scope=all&utf8=%E2%9C%93&state=closed&milestone_title=1.26.10)
...
update from 1.26.x, and we would recommend you do so at your earliest
convenience.
...
#### gstreamer
 ...
 - [aggregator: Handle gap event before segment](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10788)
 - [filesink: Fix wrong open() in overwrite mode](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10991)
 - [filesink: Report write error correctly on Windows](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10760)
 - [identity: cosmetic change to mimic fakesink](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10524)
 - [input-selector: fix several shortcomings](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10622)
 - [typefindfunctions: Promote y4m_typefind](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10631)
 - [Fix several memory leaks](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10478)
 - [Fix a couple of new const-ness warnings around strstr() usage, out-of-bounds read in PTP clock and uninitialized variable compiler warning](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10657)

#### gst-plugins-base

 - [audiodecoder / videodecoder: Fix gap event handling](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10751)
 - [decodebin3: Fix switch to smaller collections](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10675)
 - [decodebin3: Improve handling collection change on existing pad](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10640)
 - [gst: Properly unref pad template caps](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10479)
 - [input-selector: fix several shortcomings](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10622)
 - [opusenc: Use correct memcpy() size when copying Vorbis channel positions](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10985)
 - [playbin3: Move locking down to uridecodebin3](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10517)
 - [playbin3: Deadlock when loading a srt file along with a video file using gstplay](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/issues/4822)
 - [playsink: unref color balance channels with g_object_unref()](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10711)
 - [riff: Correctly check that enough RGB palette data is available](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10929)
 - [rtcp: Fix buffer overread in SDES packet parsing](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10972)
 - [rtpbuffer: Add validation for CSRC list length](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10958)
 - [rtsp: Validate transport parameter parsing in RFC 2326](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10718)
 - [typefindfunctions: Promote y4m_typefind](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10631)
 - [uridecodebin3: Fix docs for the select-stream signal](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10481)
 - [videodecoder: Handle recovery from temporary reordered output](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10693)
 - [Fix debug logging crashes](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10482)
 - [Fix several memory leaks](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10478)
 - [Fix a couple of new const-ness warnings around strstr() usage, out-of-bounds read in PTP clock and uninitialized variable compiler warning](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10657)

#### gst-plugins-good

 - [qtdemux: Don't ignore flow return when pushing queued buffers downstream](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10681)
 - [qtdemux: Fix out-of-bounds read when parsing PlayReady DRM UUIDs](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10927)
 - [qtdemux: Make sure to not output the same samples multiple times in reverse playback mode](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10691)
 - [qtdemux: Set the segment position to the start on EOS in reverse playback mode](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10630)
 - [rtspsrc: Set new mki in the encoder upon crypto update](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10757)
 - [rtph264depay: fix invalid memory access in gst_rtp_h264_finish_fragmentation_unit](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10961)
 - [rtpqdm2depay: error out if anyone tries to use this element (and remove it)](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10933)
 - [rtpsource: Add locking for receive reports table](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10699)
 - [rtptwcc: fix feedback packet count wrapping at 255](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10926)
 - [rtspsrc: fix Memory leak in gst_rtspsrc_close() when GST_RTSP_EEOF error occurs](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10769)
 - [v4l2videodec: Fix assertion failure when acquiring drm caps](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10994)
 - [wavparse: Avoid integer overflow and out-of-bounds read when parsing adtl chunks](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10936)
 - [Fix several memory leaks](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10478)
 - [Properly unref pad template caps](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10479)

#### gst-plugins-bad

 - [ajasinkcombiner: Only forward the segment events from the video sinkpad](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10749)
 - [ajasink: Only allow 6 / 8 / 16 audio channels](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10623)
 - [av1parse:  split the alignment and stream type logic](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10909)
 - [codectimestamper: Fix latency query handling](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10652)
 - [cudaupload, cudadownload: Fix CUDA/GL interop copy path](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10619)
 - [dvbsuboverlay: Add missing bounds checks to the parser everywhere](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10931)
 - [geometrictransform: Fix integer overflow in map allocation](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10468)
 - [gst: Properly unref pad template caps](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10479)
 - [h265parser: Validate num_decoding_units_minus1 in pic_timing SEI](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10937)
 - [h266parser: Fix APS ID bounds check in APS parsing](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10935)
 - [h266parser: Fix out of bounds write when parsing pic_timing SEI](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10938)
 - [h266parser: Validate tile index bounds in picture partition parsing](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10934)
 - [jpegparser: boundary checks before copying it](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10932)
 - [kaleidoscope: Fix potential division by zero in geometric transform](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10453)
 - [mxfdemux: always send a segment before sending eos or segment-done](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10651)
 - [mxfdemux: fix gst_mxf_demux_pad_get_stream_time ()](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10634)
 - [GstPlay: Ignore streams-selected messages for old selections and other fixes](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10516)
 - [GstPlay: fix segmentation fault due to use after free](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10659)
 - [srtpenc: preserve ROC when master key is updated for an ongoing session](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10978)
 - [svtav1enc: handle deprecations from SVT-AV1 4.0.0](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10545)
 - [tsdemux: Fix Continuity Counter handling](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10644)
 - [vtdec: Don't re-create session if only the framerate changed](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10703)
 - [vtdec: Fix CM memory leak due to incorrect unref](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10796)
 - [vtdec: Fix race condition when negotiating during playback](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10716)
 - [vtdec: Reverse playback fixes](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10655)
 - [webrtc: sink floating refs of ICE transports](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10628)
 - [Fix several memory leaks](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10478)
 - [Fix a couple of new const-ness warnings around strstr() usage, out-of-bounds read in PTP clock and uninitialized variable compiler warning](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10657)

#### gst-plugins-ugly

 - [asfdemux: Error out on files with more than 32 streams](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10928)
 - [rmdemux: Check if new video fragment overflows the fragment storage before storing it](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10930)

#### GStreamer Rust plugins


 - [audiornnoise: Fix audio level value reporting](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2779)
 - [aws: Don't run whole GStreamer tests in a tokio runtime](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2884)
 - [awstranscriber2: workaround suspected rust SDK regression](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2850)
 - [Block on a tokio runtime if available instead of going via futures::executor()](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2843)
 - [cargo_wrapper: Add nasm dir to path only if needed](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2899)
 - [elevenlabs,speechmatics: fix license](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2864)
 - [Fix a couple of new clippy 1.93 warnings](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2831)
 - [gtk4: Require at least GStreamer 1.18 instead of 1.16](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2819)
 - [gtk4paintablesink: Error out in NULL->READY if there is no default GDK display](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2931)
 - [Ignore return value when pushing gap events](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2841)
 - [isobmff: don't overlay durations on fragment header buffers](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2825)
 - [livesync: ignore upstream latency when upstream is not live](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2878)
 - [meson: align minor version with cargo](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2922)
 - [polly: don't panic when no caps were received before first buffer](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2881)
 - [Port from rustls-pemfile to rustls-pki-types](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2788)
 - [rtp: basepay2: Consider size of header extensions in maximum payload size](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2784)
 - [rtp: Fix amr tests test_amr_{nb,wb}_bit_packed](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2793)
 - [rtprecv: Don't panic if no buffers of a bufferlist can be directly forwarded](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2846)
 - [rtpsend: send mandatory events on the rtcp srcpad before sending the first buffer](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2900)
 - [rtpsmpte291depay: Drop the current packet after processing if it was empty](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2876)
 - [rtp: smpte291: Use upper-case encoding-name](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2866)
 - [rtp: smpte291: Use video as media type instead of application](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2848)
 - [speechmaticstranscriber: fix diarization=none](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2813)
 - [st2038combiner: Sort by line and then horizontal offset](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2874)
 - [st2038combiner: Various minor fixes](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2858)
 - [threadshare: fix socket leak in ts-udpsink](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2921)
 - [tracers: Update to signal-hook 0.4](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2782)
 - [transcriberbin: fix latency reported when transcriber=translationbin](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2886)
 - [webrtc: only register data channels for internal use](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2801)
 - [webrtcsink: check for encoder properties to handle NVIDIA platform differences](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2800)
 - [webrtcsink: don't upscale when mitigating low bitrate](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2737)
 - [Update dependencies](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2791)
 - [Update dependencies](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2836)
 - [Update dependencies](https://gitlab.freedesktop.org/gstreamer/gst-plugins-rs/-/merge_requests/2854)

#### gst-libav

 - [audiodecoder / videodecoder: Fix gap event handling](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10751)
 - [avviddec: Handle field/order changes in mixed interlace mode](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10697)
 - [Don't process lines that won't be outputted](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10817)
 - [Fix several memory leaks](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10478)
...
#### gst-python
 ...
 - [Python typing](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10626)
 - [python: Import typing_extension only when type checking](https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/10544)
...
#### Cerbero build tool and packaging changes in 1.26.11
 ...
 - [gdk-pixbuf: Re-enabled disabled loaders](https://gitlab.freedesktop.org/gstreamer/cerbero/-/merge_requests/2075)
 - [gst-plugins-bad: Ship the mse plugin](https://gitlab.freedesktop.org/gstreamer/cerbero/-/merge_requests/2058)
 - [libpng: update to 1.6.55](https://gitlab.freedesktop.org/gstreamer/cerbero/-/merge_requests/2102)
 - [pygobject.recipe: Fix overflow when comparing GstMessageType on Windows](https://gitlab.freedesktop.org/gstreamer/cerbero/-/merge_requests/2099)

#### Contributors to 1.26.11

Adrian Perez de Castro, Andrey Sidorov, Carlos Bentzen, Christopher Degawa,
Doug Nazar, Edward Hervey, François Laignel, Gang Zhao, He Junyan, Hou Qi,
James Liu, Jeongmin Kwak, Jerome Colle, Jiayin Zhang, Mathieu Duponchelle,
Matthew Waters, Nirbheek Chauhan, Ognyan Tonchev, Peter Stensson,
Philippe Normand, Piotr Brzeziński, Ruben Gonzalez, Sanchayan Maity,
Sebastian Dröge, Seungha Yang, Tim-Philipp Müller, Tobias Schlager,
Víctor Manuel Jáquez Leal, Vitaly Vlasov, Xabier Rodriguez Calvar,
Xavier Claessens,
...
- [List of Merge Requests applied in 1.26.11](https://gitlab.freedesktop.org/groups/gstreamer/-/merge_requests?scope=all&utf8=%E2%9C%93&state=merged&milestone_title=1.26.11)
- [List of Issues fixed in 1.26.11](https://gitlab.freedesktop.org/groups/gstreamer/-/issues?scope=all&utf8=%E2%9C%93&state=closed&milestone_title=1.26.11)

## Schedule for 1.28

[GStreamer 1.28][gstreamer-1.28] was released on 27 January 2026.
- - -
