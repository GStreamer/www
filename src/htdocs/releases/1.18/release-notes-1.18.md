...
The latest bug-fix release in the 1.18 series is [1.18.4](#1.18.4) and was released on 15 March 2021.

See [https://gstreamer.freedesktop.org/releases/1.18/][latest] for the latest version of this document.

*Last updated: Monday 15 March 2021, 13:00 UTC [(log)][gitlog]*
...
The plan for the 1.20 development cycle is yet to be confirmed, but it is now expected that feature freeze will take place some time in April 2021, with the first 1.20 stable release hopefully around April/May 2021.
