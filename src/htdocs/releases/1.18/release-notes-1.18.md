...
The latest bug-fix release in the 1.18 series is [1.18.5](#1.18.5) and was released on 8 September 2021.

See [https://gstreamer.freedesktop.org/releases/1.18/][latest] for the latest version of this document.

*Last updated: Wednesday 8 September 2021, 11:00 UTC [(log)][gitlog]*
...
The plan for the 1.20 development cycle is yet to be confirmed, but it is now expected that feature freeze will take place some time in September/October 2021, with the first 1.20 stable release hopefully towards the end of October 2021.
