...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <p>If desired, emails to the security list can be encrypted using either of these GPG keys:
      <ul>
          <li>4096R/86C2D7B5 fingerprint 7F4B C7CC 3CA0 6F97 336B BFEB 0668 CC14 86C2 D7B5 (sebastian@centricular.com)</li>
          <li>4096R/8625F39E fingerprint B32B 24B4 8737 B503 47EC 9491 4A9D C757 8625 F39E (jan@centricular.com)</li>
      </ul>
  </p>
