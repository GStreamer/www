...
The latest stable release is **1.28.4**. Installers are available for the following targets:

* [MSVC x86_64 (VS 2022, Release CRT)](/data/pkg/windows/1.28.4/msvc/gstreamer-1.0-msvc-x86_64-1.28.4.exe)
* [MSVC x86 (VS 2022, Release CRT)](/data/pkg/windows/1.28.4/msvc/gstreamer-1.0-msvc-x86-1.28.4.exe)
* [MSVC arm64 (VS 2022, Release CRT)](/data/pkg/windows/1.28.4/msvc/gstreamer-1.0-msvc-arm64-1.28.4.exe)
* [MinGW x86_64](/data/pkg/windows/1.28.4/mingw/gstreamer-1.0-mingw-x86_64-1.28.4.exe)
* [MinGW x86](/data/pkg/windows/1.28.4/mingw/gstreamer-1.0-mingw-x86-1.28.4.exe)
...
* **macOS Universal (X86_64 &amp; ARM64) 1.28 release (current stable version)**
  - **[1.28.4 runtime installer](/data/pkg/osx/1.28.4/gstreamer-1.0-1.28.4-universal.pkg)**
  - **[1.28.4 development installer](/data/pkg/osx/1.28.4/gstreamer-1.0-devel-1.28.4-universal.pkg)**
  - **[1.28.4 debug installer](/data/pkg/osx/1.28.4/gstreamer-1.0-debug-1.28.4-universal.pkg)**
...
[![openSUSE Leap 15.6 package](https://repology.org/badge/version-for-repo/opensuse_leap_15_6/gstreamer.svg?header=openSUSE%2015.6)](https://repology.org/project/gstreamer/versions)
[![openSUSE Tumbleweed package](https://repology.org/badge/version-for-repo/opensuse_tumbleweed/gstreamer.svg?header=openSUSE%20Tumbleweed)](https://repology.org/project/gstreamer/versions)
[![Ubuntu 24.04 LTS package](https://repology.org/badge/version-for-repo/ubuntu_24_04/gstreamer.svg?header=Ubuntu%20LTS)](https://repology.org/project/gstreamer/versions)
[![Ubuntu 26.04 package](https://repology.org/badge/version-for-repo/ubuntu_26_04/gstreamer.svg?header=Ubuntu%2026.04)](https://repology.org/project/gstreamer/versions)
...
* **Android Universal [1.28.4 tarball](/data/pkg/android/1.28.4/gstreamer-1.0-android-universal-1.28.4.tar.xz) (current stable version)**
...
and X86_64). Starting with 1.28.4, it also supports tvOS, and tvOS Simulator
(ARM64 and X86_64).

* **iOS &amp; tvOS [1.28.4 xcframework](/data/pkg/ios/1.28.4/gstreamer-1.28.4-xcframework.tar.xz) (current stable version)**
* **iOS Universal [1.28.4 legacy framework](/data/pkg/ios/1.28.4/gstreamer-1.0-devel-1.28.4-ios-universal.pkg) (current stable version)**
