...
* MSVC 64-bit (VS 2019, Release CRT)
  - [1.26.5 runtime installer](/data/pkg/windows/1.26.5/msvc/gstreamer-1.0-msvc-x86_64-1.26.5.msi)
  - [1.26.5 development installer](/data/pkg/windows/1.26.5/msvc/gstreamer-1.0-devel-msvc-x86_64-1.26.5.msi)
* MSVC 32-bit (VS 2019, Release CRT)
  - [1.26.5 runtime installer](/data/pkg/windows/1.26.5/msvc/gstreamer-1.0-msvc-x86-1.26.5.msi)
  - [1.26.5 development installer](/data/pkg/windows/1.26.5/msvc/gstreamer-1.0-devel-msvc-x86-1.26.5.msi)
* MinGW 64-bit
  - [1.26.5 runtime installer](/data/pkg/windows/1.26.5/mingw/gstreamer-1.0-mingw-x86_64-1.26.5.msi)
  - [1.26.5 development installer](/data/pkg/windows/1.26.5/mingw/gstreamer-1.0-devel-mingw-x86_64-1.26.5.msi)
* MinGW 32-bit
  - [1.26.5 runtime installer](/data/pkg/windows/1.26.5/mingw/gstreamer-1.0-mingw-x86-1.26.5.msi)
  - [1.26.5 development installer](/data/pkg/windows/1.26.5/mingw/gstreamer-1.0-devel-mingw-x86-1.26.5.msi)

For each of the above listed targets, [a zip file with `.msm` modules](/data/pkg/windows/1.26.5/)
...
* **macOS Universal (X86_64 &amp; ARM64) 1.24 release (current stable version)**
  - **[1.26.5 runtime installer](/data/pkg/osx/1.26.5/gstreamer-1.0-1.26.5-universal.pkg)**
  - **[1.26.5 development installer](/data/pkg/osx/1.26.5/gstreamer-1.0-devel-1.26.5-universal.pkg)**
...
* **Android Universal [1.26.5 tarball](/data/pkg/android/1.26.5/gstreamer-1.0-android-universal-1.26.5.tar.xz) (current stable version)**
...
* **iOS Universal [1.26.5 framework](/data/pkg/ios/1.26.5/gstreamer-1.0-devel-1.26.5-ios-universal.pkg) (ARM64, X86_64) (current stable version)**
