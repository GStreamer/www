...
* MSVC 64-bit (VS 2019, Release CRT)
  - [1.20.2 runtime installer](/data/pkg/windows/1.20.2/msvc/gstreamer-1.0-msvc-x86_64-1.20.2.msi)
  - [1.20.2 development installer](/data/pkg/windows/1.20.2/msvc/gstreamer-1.0-devel-msvc-x86_64-1.20.2.msi)
* MSVC 32-bit (VS 2019, Release CRT)
  - [1.20.2 runtime installer](/data/pkg/windows/1.20.2/msvc/gstreamer-1.0-msvc-x86-1.20.2.msi)
  - [1.20.2 development installer](/data/pkg/windows/1.20.2/msvc/gstreamer-1.0-devel-msvc-x86-1.20.2.msi)
* MinGW 64-bit
  - [1.20.2 runtime installer](/data/pkg/windows/1.20.2/mingw/gstreamer-1.0-mingw-x86_64-1.20.2.msi)
  - [1.20.2 development installer](/data/pkg/windows/1.20.2/mingw/gstreamer-1.0-devel-mingw-x86_64-1.20.2.msi)
* MinGW 32-bit
  - [1.20.2 runtime installer](/data/pkg/windows/1.20.2/mingw/gstreamer-1.0-mingw-x86-1.20.2.msi)
  - [1.20.2 development installer](/data/pkg/windows/1.20.2/mingw/gstreamer-1.0-devel-mingw-x86-1.20.2.msi)

For each of the above listed targets, [a zip file with `.msm` modules](/data/pkg/windows/1.20.2/)
...
* UWP Universal (ARM64, X86, X86_64) (VS 2019, Release CRT)
  - [1.20.2 runtime + development tarball](/data/pkg/windows/1.20.2/uwp/gstreamer-1.0-uwp-universal-1.20.2.tar.xz)
* UWP Universal (ARM64, X86, X86_64) (VS 2019, Debug CRT)
  - [1.20.2 runtime + development tarball](/data/pkg/windows/1.20.2/uwp/gstreamer-1.0-uwp+debug-universal-1.20.2.tar.xz)
...
* **macOS Universal (X86_64 &amp; ARM64) 1.20 release (current stable version)**
  - **[1.20.2 runtime installer](/data/pkg/osx/1.20.2/gstreamer-1.0-1.20.2-universal.pkg)**
  - **[1.20.2 development installer](/data/pkg/osx/1.20.2/gstreamer-1.0-devel-1.20.2-universal.pkg)**
...
* **Android Universal [1.20.2 tarball](/data/pkg/android/1.20.2/gstreamer-1.0-android-universal-1.20.2.tar.xz) (current stable version)**
...
* **iOS Universal [1.20.2 framework](/data/pkg/ios/1.20.2/gstreamer-1.0-devel-1.20.2-ios-universal.pkg) (ARM64, X86_64) (current stable version)**
