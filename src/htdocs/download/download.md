...
The latest stable release is **1.28.5**. Installers are available for the following targets:

* [MSVC x86_64 (VS 2022, Release CRT)](/data/pkg/windows/1.28.5/msvc/gstreamer-1.0-msvc-x86_64-1.28.5.exe)
* [MSVC x86 (VS 2022, Release CRT)](/data/pkg/windows/1.28.5/msvc/gstreamer-1.0-msvc-x86-1.28.5.exe)
* [MSVC arm64 (VS 2022, Release CRT)](/data/pkg/windows/1.28.5/msvc/gstreamer-1.0-msvc-arm64-1.28.5.exe)
* [MinGW x86_64](/data/pkg/windows/1.28.5/mingw/gstreamer-1.0-mingw-x86_64-1.28.5.exe)
* [MinGW x86](/data/pkg/windows/1.28.5/mingw/gstreamer-1.0-mingw-x86-1.28.5.exe)
...
* **macOS Universal (X86_64 &amp; ARM64) 1.28 release (current stable version)**
  - **[1.28.5 runtime installer](/data/pkg/osx/1.28.5/gstreamer-1.0-1.28.5-universal.pkg)**
  - **[1.28.5 development installer](/data/pkg/osx/1.28.5/gstreamer-1.0-devel-1.28.5-universal.pkg)**
  - **[1.28.5 debug installer](/data/pkg/osx/1.28.5/gstreamer-1.0-debug-1.28.5-universal.pkg)**
...
* **Android Universal [1.28.5 tarball](/data/pkg/android/1.28.5/gstreamer-1.0-android-universal-1.28.5.tar.xz) (current stable version)**
...
and X86_64). Starting with 1.28.5, it also supports tvOS, and tvOS Simulator
(ARM64 and X86_64).

* **iOS &amp; tvOS [1.28.5 xcframework](/data/pkg/ios/1.28.5/gstreamer-1.28.5-xcframework.tar.xz) (current stable version)**
* **iOS Universal [1.28.5 legacy framework](/data/pkg/ios/1.28.5/gstreamer-1.0-devel-1.28.5-ios-universal.pkg) (current stable version)**
