...
* MSVC 64-bit (VS 2019, Release CRT)
  - [1.18.4 runtime installer](/data/pkg/windows/1.18.4/msvc/gstreamer-1.0-msvc-x86_64-1.18.4.msi)
  - [1.18.4 development installer](/data/pkg/windows/1.18.4/msvc/gstreamer-1.0-devel-msvc-x86_64-1.18.4.msi)
* MSVC 32-bit (VS 2019, Release CRT)
  - [1.18.4 runtime installer](/data/pkg/windows/1.18.4/msvc/gstreamer-1.0-msvc-x86-1.18.4.msi)
  - [1.18.4 development installer](/data/pkg/windows/1.18.4/msvc/gstreamer-1.0-devel-msvc-x86-1.18.4.msi)
* MinGW 64-bit
  - [1.18.4 runtime installer](/data/pkg/windows/1.18.4/mingw/gstreamer-1.0-mingw-x86_64-1.18.4.msi)
  - [1.18.4 development installer](/data/pkg/windows/1.18.4/mingw/gstreamer-1.0-devel-mingw-x86_64-1.18.4.msi)
* MinGW 32-bit
  - [1.18.4 runtime installer](/data/pkg/windows/1.18.4/mingw/gstreamer-1.0-mingw-x86-1.18.4.msi)
  - [1.18.4 development installer](/data/pkg/windows/1.18.4/mingw/gstreamer-1.0-devel-mingw-x86-1.18.4.msi)

For each of the above listed targets, [a zip file with `.msm` modules](/data/pkg/windows/1.18.4/)
...
* UWP Universal (ARM64, X86, X86_64) (VS 2019, Release CRT)
  - [1.18.4 runtime + development tarball](/data/pkg/windows/1.18.4/uwp/gstreamer-1.0-uwp-universal-1.18.4.tar.xz)
* UWP Universal (ARM64, X86, X86_64) (VS 2019, Debug CRT)
  - [1.18.4 runtime + development tarball](/data/pkg/windows/1.18.4/uwp/gstreamer-1.0-uwp+debug-universal-1.18.4.tar.xz)
...
* macOS 64-bit (target: macOS 10.11)
  - [1.18.4 runtime installer](/data/pkg/osx/1.18.4/gstreamer-1.0-1.18.4-x86_64.pkg)
  - [1.18.4 development installer](/data/pkg/osx/1.18.4/gstreamer-1.0-devel-1.18.4-x86_64.pkg)
...
* Android Universal [1.18.4 tarball](/data/pkg/android/1.18.4/gstreamer-1.0-android-universal-1.18.4.tar.xz)
...
* iOS Universal [1.18.4 framework](/data/pkg/ios/1.18.4/gstreamer-1.0-devel-1.18.4-ios-universal.pkg) (ARM64, X86_64)
